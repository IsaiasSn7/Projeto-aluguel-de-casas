      ...
      <div className="bg-white p-[10px] w-[350px] rounded-[5px] lg:w-[400px]">
        ...
        <div className="flex h-[400px] flex-col items-center justify-center">
          ...
          <form className="flex flex-col text-[16px] mb-[20px]">
            ...
            <input
              className="mb-[20px] h-[45px] w-[300px] rounded-[5px] bg-gray-200 border border-gray-300 focus:border-Laranja outline-none px-4 py-2 duration-200"
              type="email"
            />
            ...
            <div className="relative w-[300px]">
              <input
                className="h-[45px] w-full rounded-[5px] bg-gray-200 border border-gray-300 focus:border-Laranja outline-none px-4 py-2 pr-10 duration-200"
